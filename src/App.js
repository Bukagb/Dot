      ...
      <BrowserRouter>
        <Routes>
          <Route exact path="/" element={<Home />} />
            <Route exact path="dot" element={<Dot />} />
...
//   return (
//     <div className="App">
//       <img src={img} className='alter' alt="..."/>
//       <p>
//         Lorem Bukunmi Agbetunsin Doing one of the following things could help Checking the network cable or router Resetting the modem or router Reconnecting to Wi-Fi
//       </p>
